	...
	return function(e) {
			...
			String.prototype.trim || (String.prototype.trim = function() {
				...
				on: function(e, t, n) {
					return l.default.fn.off(e, t, n), this.forEach(function(r) {
						e.split(" ").forEach(function(e) {
							r.addEventListener ? r.addEventListener(e, t, n || !1) : r.attachEvent ? r.attachEvent("on" + e, t) :
								r["on" + e] = t
						})
					}), this
				},
				off: function(e, t, n) {
					return this.forEach(function(r) {
						e.split(" ").forEach(function(e) {
							r.removeEventListener ? r.removeEventListener(e, t, n || !1) : r.detachEvent ? r.detachEvent("on" + e,
								t) : r["on" + e] = null
						})
					}), this
				},
				...
				attr: function() {
					...
					return "string" == typeof arguments[0] && arguments.length < 2 ? this[0].getAttribute(arguments[0]) || "" :
				...
				ajax: function(e) {
					e = e || {}, e.type = (e.type || "GET").toUpperCase(), e.dataType = e.dataType || "json", e.async = e.async ||
						!0, e.timeout = e.timeout || 8e3;
					...
					}, "GET" == e.type ? (r.open("GET", e.url + "?" + t, e.async), r.send(null)) : "POST" == e.type && (r.open(
						"POST", e.url, e.async), void 0 == e.contentType || null == e.contentType ? r.send(t) : (r.setRequestHeader(
						"Content-Type", e.contentType), r.send(JSON.stringify(e.data)))), n = setTimeout(function(e) {
		...
		var i, a, s = function() {
			...
			x = function(e, t) {
				...
				if (void 0 === v[e] && !t) throw new r("intrinsic " + e +
		...
		t.DEFAULT_EMOJI_CDN = "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/", t.DB_NAME = "Comment", t.defaultConfig = {
			...
			(Date.now() + Math.round(1e3 * Math.random())).toString(32), t.VERSION = "1.4.14"
	}, function(e, t, n) {
		function r(e, t) {
		...
		t.whiteList = r(), t.getDefaultWhiteList = r, t.onTag = o, t.onIgnoreTag = i, t.onTagAttr = a, t.onIgnoreTagAttr =
			...
			f, t.clearNonPrintableCharacter = h, t.friendlyAttrValue = v, t.escapeAttrValue = g, t.onIgnoreTagStripAll = m,
		...
		*/
		...
		o.prototype.init = function(e) {
			...
			var t = this;
			return e && (e = y.default.extend(h.defaultConfig, e), t.i18n = (0, d.default)(e.lang || y.default.lang, e.langMode),
				t.config = e, f.default.maps = !!e.emojiMaps && e.emojiMaps || f.default.maps, f.default.cdn = !!e.emojiCDN &&
				e.emojiCDN || f.default.cdn, t._init()), t
			...
			try {
				...
				var u = T.ds,
					d = r ? "&q=" + h.RandomStr : "";
				T.params = "?d=" + (u.indexOf(n) > -1 ? n : "mp") + "&v=" + h.VERSION + d, T.hide = "hide" === n, T.cdn =
					/^https?\:\/\//.test(o) ? o : T.cdn, e.config.pageSize = isNaN(l) ? 10 : l < 1 ? 10 : l, c && (0, _.recordIPFn)
					(function(e) {
						return E.ip = e
					});
				...
				if (p = p instanceof HTMLElement ? p : f[f.length - 1] || null) {
					e.$el = (0, y.default)(p), e.$el.addClass("v").attr("data-class", "v"), T.hide && e.$el.addClass(
						"hide-avatar"), e.config.meta = (e.config.guest_info || e.config.meta || h.defaultMeta).filter(function(e) {
					...
					var v = (0 == e.config.meta.length ? h.defaultMeta : e.config.meta).map(function(t) {
							...
							return h.defaultMeta.indexOf(t) > -1 ? '<input name="' + t + '" placeholder="' + e.i18n.t(t) +
								'" class="v' + t + ' vinput" type="' + n + '">' : ""
						}),
						g =
			...
			I = {
				...
				show: function(e, t) {
					...
					if (t.forEach(function(e) {
							...
							t && t.text("0"), n.push(/\%/.test((0, y.default)(e).attr("id")) ? decodeURI((0, y.default)(e).attr("id")) :
		...
		o.prototype.Q = function(e) {
			...
			var e = this,
				...
				u = function(e) {
					var n = [];
					for (var r in a) a.hasOwnProperty(r) && !!f.default.build(r) && n.push('<i title="' + r + '" >' + f.default.build(
						r) + "</i>");
			...
			var d = function(t) {
				...
				r || e.$preview.hide(), j != r && (j = r, o.hasClass("actived") > -1 && j != n.html() && n.html(j), (0, c.default)
					(t[0]), M())
			};
			...
			for (var b in m) m.hasOwnProperty(b) && function() {
				...
				v[t] = n, n.on("input change blur propertychange", function(r) {
					e.config.enableQQ && "blur" === r.type && "nick" === t && (isNaN(n.val()) ? y.default.store.get(h.QQCacheKey) &&
						y.default.store.get(h.QQCacheKey).nick != n.val() && (y.default.store.remove(h.QQCacheKey), E.nick = n.val(),
							E.mail = "", E.QQAvatar = "") : (0, _.fetchQQFn)(n.val(), function(e) {
							var t = e.nick || n.val(),
								r = e.qq + "@qq.com";
							(0, y.default)(".vnick").val(t), (0, y.default)(".vmail").val(r), E.nick = t, E.mail = r, E.QQAvatar =
								e.pic
						})), "comment" === t ? d(n) : E[t] = y.default.escape(n.val().replace(/(^\s*)|(\s*$)/g, "")).substring(0,
						40)
				})
			}();
			var x = function(e, t) {
			...
			var C = function(t, n, r) {
					var o = (0, y.default)('<div class="vcard" id="' + t.id + '"></div>'),
						i = t.get("ua"),
						a = "";
					i && !/ja/.test(e.config.lang) && (i = y.default.detect(i), a = '<span class="vsys">' + i.browser + " " + i.version +
					...
					var l = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : "http://" + t.get("link") : "",
						...
						u = T.hide ? "" : e.config.enableQQ && t.get("QQAvatar") ? '<img class="vimg" src="' + t.get("QQAvatar") +
						'" referrerPolicy="no-referrer"/>' : '<img class="vimg" src="' + (T.cdn + (0, s.default)(t.get("mail")) + T.params) +
						'">',
						d = u + '<div class="vh"><div class="vhead">' + c + " " + a +
						'</div><div class="vmeta"><span class="vtime" >' + (0, g.default)(t.get("insertedAt"), e.i18n) +
						'</span><span class="vat" data-vm-id="' + (t.get("rid") || t.id) + '" data-self-id="' + t.id + '">' + e.i18n
						.t("reply") + '</span></div><div class="vcontent" data-expand="' + e.i18n.t("expand") + '">' + (0, S.default)
					...
					setTimeout(function() {
						try {
							"MathJax" in window && "version" in window.MathJax && (/^3.*/.test(window.MathJax.version) && MathJax.typeset() ||
								...
								window && renderMathInElement((0, y.default)(".v")[0], {
									delimiters: [{
										left: "$$",
										right: "$$",
										display: !0
			...
			! function(t) {
				...
				E.comment = "", v.comment.val(""), d(v.comment), v.comment.attr("placeholder", e.config.placeholder), I = {},
					e.$preview.hide(), e.$el.find(".vpanel").append(e.$el.find(".vwrap")), e.$el.find(".cancel-reply").hide(), j =
					""
			};
			var z = e.$el.find(".vsubmit"),
				L = function(t) {
					if (e.config.requiredFields.indexOf("nick") > -1 && E.nick.length < 3) return v.nick[0].focus(), void e.$el.find(
						".status-bar").text("" + e.i18n.t("nickFail")).empty(3e3);
					if (e.config.requiredFields.indexOf("mail") > -1 && !/[\w-\.]+@([\w-]+\.)+[a-z]{2,3}/.test(E.mail)) return v.mail[
						0].focus(), void e.$el.find(".status-bar").text("" + e.i18n.t("mailFail")).empty(3e3);
				...
				U = function() {
					...
					if (E.url = decodeURI(e.config.path), E.insertedAt = new Date, I.rid) {
						var r = I.pid || I.rid;
						n.set("rid", I.rid), n.set("pid", r), E.comment = j.replace("<p>", '<p><a class="at" href="#' + r + '">' + I
							.at + "</a> , ")
					}
					for (var o in E)
						...
						try {
							I.rid ? C(t, (0, y.default)('.vquote[data-self-id="' + I.rid + '"]'), !0) : (Number(n.text()) ? n.text(
								Number(n.text()) + 1) : e.$el.find(".vcount").show().find(".vnum").text(Number(n.text()) + 1), C(t, e.$el
								.find(".vcards")), k.skip++), z.removeAttr("disabled"), e.$loading.hide(), e.reset()
						} catch (t) {
							(0, $.default)(e, t, "save")
						}
					}).catch(function(t) {
			...
			z.on("click", L), (0, y.default)(document).on("keydown", function(e) {
				...
				((e.ctrlKey || e.metaKey) && 13 === t && L(), 9 === t) && ("veditor" == (document.activeElement.id || "") &&
					...
					if (o > 0) {
						...
						x(i[0], s), Q(a, function(l) {
							500 != l.code ? (i.val(i.val().replace(s, "![" + a.name + "](" + l.data.url + ")\r\n")), (0, c.default)(i[
								0]), ++r < o ? t(n, r) : z.removeAttr("disabled")) : (i.val(i.val().replace(s, "")), (0, c.default)(i[0]),
								e.$el.find(".status-bar").text(l.msg).empty(3e3), z.removeAttr("disabled"))
						})
					}
				},
				Q = function(e, t) {
		...
		t.default = function(e, t) {
			...
			i ? t && t() : o.default.sdkLoader("//cdn.jsdelivr.net/npm/leancloud-storage@3/dist/av-min.js", "AV", function(
				n) {
				var r = "https://",
					o = "",
					a = e.app_id || e.appId,
		...
		t.__esModule = !0, t.default = function(e, t) {
			if (e.$el && e.$loading.hide().$nodata.hide(), "[object Error]" === {}.toString.call(t)) {
				...
				if (isNaN(n)) e.$el && e.$nodata.show('<pre style="text-align:left;"> ' + JSON.stringify(t) + "</pre>");
					...
					101 == n || -1 == n ? e.$nodata.show() : e.$el && e.$nodata.show('<pre style="text-align:left;">Code ' + n +
						": " + o + "</pre>")
				}
		...
		var o = n(36),
			...
			d = new o.Renderer;
		d.code = function(e, t) {
			return '<pre><code class="hljs language-' + t + '">' + (!t || !hljs.getLanguage(t) ? s.default.escape(e) : hljs
				.highlight(t, e).value) + "</code></pre>"
		}, i.default.setOptions({
			renderer: "hljs" in window ? d : new o.Renderer,
			highlight: function(e, t) {
				return "hljs" in window ? t && hljs.getLanguage(t) && hljs.highlight(t, e, !0).value || hljs.highlightAuto(e)
					.value : u(e)
			},
			gfm: !0,
			tables: !0,
		...
		var i = function(e, t, n, r) {
			if (/code|pre|span/gi.test(e)) {
				if ("style" == t) return t + '="' + (/^color/gi.test(n) ? n : "").replace(/(color:[#0-9a-fA-F]{1,6};?).+/gi,
					"$1") + '"';
				if ("class" == t) return t + "='" + o.default.escapeAttrValue(n) + "'"
			}
			if ("img" === e && ["src", "class"].indexOf(t) > -1) return t + '="' + o.default.escapeAttrValue(n) +
		...
		! function(o) {
			...
			function p(e, t) {
				...
				var n, r, o, a, s, p = 1732584193,
					...
					h = -1732584194,
					v = 271733878;
				for (n = 0; n < e.length; n += 16) r = p, o = f, a = h, s = v, p = l(p, f, h, v, e[n], 7, -680876936), v = l(v,
					...
					l(f, h, v, p, e[n + 11], 22, -1990404162), p = l(p, f, h, v, e[n + 12], 7, 1804603682), v = l(v, p, f, h, e[n +
						...
						14, 1735328473), f = c(f, h, v, p, e[n + 12], 20, -1926607734), p = u(p, f, h, v, e[n + 5], 4, -378558), v =
					u(v, p, f, h, e[n + 8], 11, -2022574463), h = u(h, v, p, f, e[n + 11], 16, 1839030562), f = u(f, h, v, p, e[n +
						14], 23, -35309556), p = u(p, f, h, v, e[n + 1], 4, -1530992060), v = u(v, p, f, h, e[n + 4], 11, 1272893353),
					h = u(h, v, p, f, e[n + 7], 16, -155497632), f = u(f, h, v, p, e[n + 10], 23, -1094730640), p = u(p, f, h, v,
						e[n + 13], 4, 681279174), v = u(v, p, f, h, e[n], 11, -358537222), h = u(h, v, p, f, e[n + 3], 16, -722521979),
					f = u(f, h, v, p, e[n + 6], 23, 76029189), p = u(p, f, h, v, e[n + 9], 4, -640364487), v = u(v, p, f, h, e[n +
						12], 11, -421815835), h = u(h, v, p, f, e[n + 15], 16, 530742520), f = u(f, h, v, p, e[n + 2], 23, -995338651),
					p = d(p, f, h, v, e[n], 6, -198630844), v = d(v, p, f, h, e[n + 7], 10, 1126891415), h = d(h, v, p, f, e[n +
						14], 15, -1416354905), f = d(f, h, v, p, e[n + 5], 21, -57434055), p = d(p, f, h, v, e[n + 12], 6, 1700485571),
					v = d(v, p, f, h, e[n + 3], 10, -1894986606), h = d(h, v, p, f, e[n + 10], 15, -1051523), f = d(f, h, v, p, e[
						n + 1], 21, -2054922799), p = d(p, f, h, v, e[n + 8], 6, 1873313359), v = d(v, p, f, h, e[n + 15], 10, -
						30611744), h = d(h, v, p, f, e[n + 6], 15, -1560198380), f = d(f, h, v, p, e[n + 13], 21, 1309151649), p = d(
						p, f, h, v, e[n + 4], 6, -145523070), v = d(v, p, f, h, e[n + 11], 10, -1120210379), h = d(h, v, p, f, e[n +
						2], 15, 718787259), f = d(f, h, v, p, e[n + 9], 21, -343485551), p = i(p, r), f = i(f, o), h = i(h, a), v = i(
						v, s);
				return [p, f, h, v]
			}
					...
					v.normal = p({}, v), v.gfm = p({}, v.normal, {
						...
						for (var n, r, o, i, a, s, l, c, u, d, p, h, g; e;)
							...
							for (e = e.substring(o[0].length), i = o[2], p = i.length > 1, this.tokens.push({
								...
								d - 1 && (a = v.bullet.exec(o[c + 1])[0], i === a || i.length > 1 && a.length > 1 || (e = o.slice(c + 1).join(
									"\n") + e, c = d - 1)), r = n || /\n\n(?!\s*$)/.test(s), c !== d - 1 && (n = "\n" === s.charAt(s.length -
